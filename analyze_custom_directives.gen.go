...
var customDirectives = map[string][]uint{
    "nginxaas-scaling-group": {
        ngxHTTPUpsConf | ngxConfTake1,
    },
    "nginxaas-scaling-group-opts": {
        ngxHTTPUpsConf | ngxConf1More,
    },
}

// MatchCustomDirectives contains user-defined custom directives.
func MatchCustomDirectives(directive string) ([]uint, bool) {
    m, ok := customDirectives[directive]
    return m, ok
}
